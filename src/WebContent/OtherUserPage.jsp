	...
	<div id="outerContainer">
       ...
       <div id="mainBody">
       		...
       		<div id="rightside">
       			...
       			<a href="" id="followButton"><button><span class="whiteText" id="Ftext">Follow</span></button></a>
       			<br>
       		...
       		<script>
				...
				function changeIcon()
				{
					...
					if(currIcon == "fa fa-book") document.getElementById("filtersubmit").className ="fa fa-user";
					else if(currIcon == "fa fa-user") document.getElementById("filtersubmit").className ="fa fa-book";
				}
				...
				document.getElementById("profile-pic-2").src = "<%=session.getAttribute("img-url") %>";
				...
				var alreadyFollow = <%=session.getAttribute("alreadyFollower")%>;
				if(alreadyFollow == true){
					document.getElementById("Ftext").innerHTML ="Unfollow";
					document.getElementById("followButton").href =  "UnfollowServlet?userTounfollow="+ "<%=session.getAttribute("username") %>";
				}
				else{
					document.getElementById("Ftext").innerHTML ="Follow";
					document.getElementById("followButton").href =  "FollowServlet?userTofollow="+ "<%=session.getAttribute("username") %>";
				}
